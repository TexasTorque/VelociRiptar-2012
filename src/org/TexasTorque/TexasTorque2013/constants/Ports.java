...
public class Ports
{
    ...
    //----- Motors -----
        //----- Sidecar 1 -----
        public final static int FRONT_RIGHT_DRIVE_MOTOR_PORT = 1;
        public final static int REAR_RIGHT_DRIVE_MOTOR_PORT = 3;//2
        public final static int REAR_SHOOTER_MOTOR_PORT = 9;
        public final static int FRONT_SHOOTER_MOTOR_PORT = 10;
        
        //----- Sidecar 2 -----
        public final static int FRONT_LEFT_DRIVE_MOTOR_PORT = 7;//10
        public final static int REAR_LEFT_DRIVE_MOTOR_PORT = 8;//10
        public final static int INTAKE_MOTOR_PORT = 1;
        public final static int ELEVATOR_MOTOR_PORT = 2;
        public final static int CROSS_MOTOR_PORT = 4;
    ...
    //----- Digital Inputs -----
        //----- Sidecar 1 -----
        public final static int SHOOTER_ENCODER_PORT_A = 2;
        public final static int SHOOTER_ENCODER_PORT_B = 1;
        public final static int RIGHT_DRIVE_ENCODER_A_PORT = 13;
        public final static int RIGHT_DRIVE_ENCODER_B_PORT = 14;
        
        //----- Sidecar 2 -----
        public final static int LEFT_DRIVE_ENCODER_A_PORT = 13;
        public final static int LEFT_DRIVE_ENCODER_B_PORT = 14;
        public final static int LIGHTS_R_PORT = 8;
        public final static int LIGHTS_G_PORT = 9;
        public final static int LIGHTS_B_PORT = 10;
        public final static int PRESSURE_SWITCH_PORT = 6;
        public final static int BOTTOM_LIMIT_SWITCH = 3;
        public final static int MIDDLE_LIMIT_SWITCH = 2;
        public final static int LIGHT_SENSOR_PORT = 1; 
